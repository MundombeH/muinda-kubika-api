...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleInactiveRoleException(InactiveRoleException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(new ErrorResponse("ERRO_ROLE", ex.getMessage()));
    }

    @ExceptionHandler(InsufficientAuthenticationException.class)
    public ResponseEntity<Object> handleInactiveRoleException(InsufficientAuthenticationException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(new ErrorResponse("ERRO_ROLE", ex.getMessage()));
    }

    @ExceptionHandler(RoleNameAlreayExistException.class)
    public ResponseEntity<String> handleRoleExists(RoleNameAlreayExistException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }
    ...
    public ResponseEntity<String> handleProfileAlreadyActive(ProfileAlreadyActiveException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }

    @ExceptionHandler(ProfileAlreadyRejectedException.class)
    public ResponseEntity<String> handleProfileAlreadyRejected(ProfileAlreadyRejectedException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(ex.getMessage());
    }

    @ExceptionHandler(ProfileApprovalNotFoundException.class)
    public ResponseEntity<String> handleProfileApprovalNotFound(ProfileApprovalNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(ex.getMessage());
    }
